...
class WizardEngine:
    ...
    def display_banner(self):
      ...
      /    ||──|___________|──||    \\\\
            ...
            box=box.HEAVY,
            title="[bold yellow] THE WIZARD [/bold yellow]"
        ))
    ...
    def scan_menu(self):
        ...
        while True:
            ...
            scans = [
                ...
                ("2", " Geo-IP Lookup", "Geographical location of server"),
    ...
    def basic_recon(self):
        ...
        with Progress() as progress:
            ...
            try:
                ...
                console.print(f"[cyan]  Web Server:[/cyan] [green]{server}[/green]")
            except:
            ...
            console.print(f"[cyan]  Cloudflare:[/cyan] [green]{cf}[/green]")
            progress.update(task, advance=1)
